...
##############################################################################################################################################################################
#################TEST CASE: MY NETWORK AREA - GROUPS TAB - FROM PROFILE - ADD GROUP - SCHEDULRE FILTERED REPORT - DELETE GROUP - VERIFY SCHEDULED REPORT DELETE ALSO##########
##############################################################################################################################################################################
describe "********** TEST CASE: MY NETWORK AREA - GROUPS TAB - FROM PROFILE - ADD GROUP - SCHEDULRE FILTERED REPORT - DELETE GROUP - VERIFY SCHEDULED REPORT DELETE ALSO **********" do # Created on : 27/04/2017
	...
	time_format = "24 hour"
		...
		action = "verify not exists"

		include_examples "go to scheduled reports page"
		include_examples "certain action on scheduled report line", email_address, report_name, recurring_on, group_name, action, email_address_new, see_recurring, make_recurring, time_span, time_span_day, time_span_which_day, hour, offset, verify_recurring_on

...
#############################################################################################################################################
###############TEST CASE: MY NETWORK AREA - GROUPS TAB - FROM PROFILE - ADD GROUP - VERIFY THE DASHBOARD AREA WHEN GROUP IS DELETED##########
#############################################################################################################################################
describe "********** TEST CASE: MY NETWORK AREA - GROUPS TAB - FROM PROFILE - ADD GROUP - VERIFY THE DASHBOARD AREA WHEN GROUP IS DELETED **********" do 
	...
	group_description = "TEST Description " + UTIL.ickey_shuffle(9) + " for the Group named: Copy only one AP"
		...
		include_examples "change locations and back to dashboard", "All Devices" , "Profiles", true

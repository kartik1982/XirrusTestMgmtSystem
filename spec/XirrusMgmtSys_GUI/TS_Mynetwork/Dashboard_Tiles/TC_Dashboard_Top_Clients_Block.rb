...
describe "********** TEST CASE: Test the MY NETWORK area - DASHBOARD - TILES - TOP CLIENTS - BLOCK FROM DASHBOARD **********" do
	...
	include_examples "create new tile", "US XMSC-181"
	...
	include_examples "dashboard clients block", "Top Clients (by Usage)"
	include_examples "get certain client block and unblock", "Top Clients (by Usage)"
	include_examples "delete a certain tile", "US XMSC-181"
end
...
describe "********** TEST CASE: Test the MY NETWORK area - FLOOR PLANS - CREATE, DELETE **********" do
	...
	include_examples "edit building opacity", building_name
	...
	include_examples "go to the dashboard and back to editor", building_name, ap_status, environment, scale_amout, scale_unit, address_verify

...
describe "********** TEST CASE: Test the MY NETWORK area - FLOOR PLANS - VERIFY APs on FLOORPLAN **********" do
	...
	include_examples "edit building edit ap details", building_name, ap_name, "X2-120", false, "", "", location, tags, ""
	include_examples "edit building edit ap details", building_name, ap_name, "X2-120", true, ap_name, ap_name, location, tags, ""
	include_examples "edit building edit ap details", building_name, ap_name, "X2-120", false, "", "", "", "", tags

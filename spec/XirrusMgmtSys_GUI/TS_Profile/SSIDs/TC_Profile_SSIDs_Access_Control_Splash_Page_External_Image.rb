...
#############################################################################################################
######################TEST CASE: PROFILE - SSIDs TAB - ACCESS CONTROL - Use an external image##############
#############################################################################################################
describe "********** TEST CASE: PROFILE - SSIDs TAB - ACCESS CONTROL - Use an external image **********" do
  
  profile_name = UTIL.random_profile_name + "- external image"
  ...
  include_examples "edit an ssid and add an external image on the splash page", profile_name

...
##########################################################################################################################################
################TEST CASE: PROFILE - SSIDs TAB - ENCRYPTION / AUTHENTICATION - WPA2/802.1x - AES - ALL AUTHENTICATION MODES###############
##########################################################################################################################################
describe "********** TEST CASE: PROFILE - SSIDs TAB - ENCRYPTION / AUTHENTICATION - WPA2/802.1x - AES - ALL AUTHENTICATION MODES **********" do
  ...
  include_examples "edit profile ssid encryption/auth general method", profile_name, 'Active Directory', "WPA2/802.1x", "AES", "Active Directory"
  include_examples "edit profile ssid encryption/auth general method", profile_name, 'PSK', "WPA2/802.1x", "AES", "PSK"
  include_examples "edit profile ssid encryption/auth general method", profile_name, 'EAP', "WPA2/802.1x", "AES", "EAP"

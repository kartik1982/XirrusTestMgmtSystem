...
######################################################################################################################
######################TEST CASE: PROFILE - SSIDs TAB - USE ONBOARDING PORTAL##########################################
######################################################################################################################
describe "********** TEST CASE: PROFILE - SSIDs TAB - USE ONBOARDING PORTAL **********" do
	...
	include_examples "edit an ssid and change access control to captive portal gap onboarding", profile_name, portal_name + " " + portal_type
	...
	include_examples "edit an ssid with onboarding and change portal to self registration", profile_name, portal_name + " " + portal_type

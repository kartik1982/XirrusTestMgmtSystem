...
describe "********** TEST CASE: Test the SEARCH BOX - All tabs that it appears on **********" do
	context "********** VERIFY PROFILE - ACCESS POINTS TAB **********" do
		profile_name = "PROFILE - " + UTIL.ickey_shuffle(4) + " - tile"
		decription_prefix = "Description for: " 
		include_examples "scope to tenant", "Adrian-Automation-Chrome-Tenth-Child"
  		...
  		include_examples "open profile and go to the access points tab", profile_name
  		include_examples "verify search empty"
  		include_examples "open profile go to access points tab and add aps", profile_name, 4
  		include_examples "verify search", "XR630", "OOOOO123ddsAde~", false, false
  		include_examples "scope to tenant", "Adrian-Automation-Chrome-Tenth"
	end
end
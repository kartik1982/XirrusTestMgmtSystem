...
##############################################################################################################################################
#############TEST CASE: TROUBLESHOOTING AREA - PORTAL - SELF-REGISTRATION - ADD, EDIT AND DELETE PORTALS IN UI - VERIFY AUDIT TRAIL LOG#######
##############################################################################################################################################
describe "********** TEST CASE: TROUBLESHOOTING AREA - PORTAL - SELF-REGISTRATION - ADD, EDIT AND DELETE PORTALS IN UI - VERIFY AUDIT TRAIL LOG **********" do

  portal_name = "SELF-REGISTRATION - " + UTIL.ickey_shuffle(6) + " - CREATED FROM EMPTY GRID TILE"

...
##############################################################################################################################################
#############TEST CASE: TROUBLESHOOTING AREA - PORTAL - AMBASSADOR - ADD, EDIT AND DELETE PORTALS IN UI - VERIFY AUDIT TRAIL LOG##############
##############################################################################################################################################
describe "********** TEST CASE: TROUBLESHOOTING AREA - PORTAL - AMBASSADOR - ADD, EDIT AND DELETE PORTALS IN UI - VERIFY AUDIT TRAIL LOG **********" do

  portal_name = "AMBASSADOR - " + UTIL.ickey_shuffle(6) + " - CREATED FROM EMPTY GRID TILE"

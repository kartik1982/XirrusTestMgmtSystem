...
describe "********** TEST CASE: Test the MY NETWORK area - FLOORPLANS TAB - CREATE, EDIT and DELETE **********"  do
  	...
  	include_examples "perform action verify audit trail", "CREATE", Array["Building: "+building_name], 3
  	...
  	include_examples "edit building duplicate delete floorplan", building_name
  	include_examples "go to the troubleshooting area"
  	include_examples "perform action verify audit trail", "CREATE", Array["Floor Plan: "+floor_name, "Floor Plan: Copy of "+floor_name], 1
  	...
  	#not needed already verified - Kartik AIyar
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Access Point: "+ap_sn, "Floor Plan: "+floor_name], 2
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Floor Plan: "+floor_name, "Building: "+building_name], 3
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Building: "+building_name], 4
  	# include_examples "perform action verify audit trail", "CREATE", Array["Floor Plan: "+floor_name, "Floor Plan: Copy of "+floor_name], 5
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Floor Plan: "+floor_name], 6
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Floor Plan: "+floor_name, "Building: "+building_name], 7
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Building: "+building_name], 8
  	# include_examples "perform action verify audit trail", "UPDATE", Array["Building: "+building_name], 9
  	# include_examples "perform action verify audit trail", "CREATE", Array["Building: "+building_name, "Floor Plan: "+floor_name], 10
  	#include_examples "perform action verify audit trail", "CREATE", Array["Building: "+building_name], 11
end

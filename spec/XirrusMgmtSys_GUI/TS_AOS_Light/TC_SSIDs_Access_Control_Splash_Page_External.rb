...
###########################################################################################################################################
##############TEST CASE: AOS LIGHT - PROFILE - SSIDs TAB - ACCESS CONTROL - Use SPLASH PAGE HOSTED EXTERNALLY##############################
###########################################################################################################################################

describe "********** TEST CASE: AOS LIGHT - PROFILE - SSIDs TAB - ACCESS CONTROL - Use SPLASH PAGE HOSTED EXTERNALLY **********" do
  ...
  include_examples "edit an ssid and change access control to captive portal splash page for aos light profile", profile_name

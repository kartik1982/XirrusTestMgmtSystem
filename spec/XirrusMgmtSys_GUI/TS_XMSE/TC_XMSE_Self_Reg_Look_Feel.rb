...
#####################################################################################################################
##############TEST CASE: XMS ENTERPRISE - PORTAL - SELF REGISTRATION - LOOK & FEEL TAB FEATURES######################
#####################################################################################################################
describe "********** TEST CASE: XMS ENTERPRISE - PORTAL - SELF REGISTRATION - LOOK & FEEL TAB FEATURES **********" do

  portal_name =  "SELF-REGISTRATION - " + UTIL.ickey_shuffle(5)

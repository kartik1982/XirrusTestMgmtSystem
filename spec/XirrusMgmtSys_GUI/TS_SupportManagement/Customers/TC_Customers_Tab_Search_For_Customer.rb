...
describe "********** TEST CASE: Test the SUPPORT MANAGEMENT area - CUSTOMERS TAB - SEARCH FOR CUSTOMER **********" do
  $the_environment_used=="test01" ? number_of_tenants=46 : number_of_tenants=48
	...
	include_examples "search for customer and verify grid responds", "Adrian-Automation" , number_of_tenants
end
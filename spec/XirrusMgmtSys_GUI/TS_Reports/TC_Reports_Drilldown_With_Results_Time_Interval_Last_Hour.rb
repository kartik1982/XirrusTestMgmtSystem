...
#############################################################################################################
##############TEST CASE: Test the REPORTS AREA - DRILL DOWN FEATURE WHEN HAVING RESULTS - Last hour##########
#############################################################################################################
describe "********** TEST CASE: Test the REPORTS AREA - DRILL DOWN FEATURE WHEN HAVING RESULTS - Last hour **********" do
  ...
  include_examples "edit report from tile", report_name, "Top Applications by usage", "Last Hour"
  include_examples "verify reports drilldown"
  include_examples "add drilldown application pages verify pages", 3, "Top Clients (by Usage)", "(1 hour)", nil, nil, nil, nil
  include_examples "add drilldown application pages verify values", 3, "Access Points (by Usage)", false, nil, nil, nil, nil

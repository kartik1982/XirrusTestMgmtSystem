...
#############################################################################################################
##############TEST CASE: Test the REPORTS AREA - DRILL DOWN FEATURE WHEN HAVING RESULTS - 7 days#############
#############################################################################################################
describe "********** TEST CASE: Test the REPORTS AREA - DRILL DOWN FEATURE WHEN HAVING RESULTS - 7 days **********" do
  ...
  include_examples "edit report from tile", report_name, "Top Applications by usage", "Last 7 Days"
  include_examples "verify reports drilldown"
  include_examples "add drilldown application pages verify pages", 7, "Top Clients (by Usage)", "(7 days)", nil, nil, nil, nil
  include_examples "add drilldown application pages verify values", 7, "Access Points (by Usage)", false, nil, nil, nil, nil

...
# GET - Get count of  total, used and available Guest Accounts
#
# @return [XMS::NG::ApiClient::Response]
def get_count_of__total,_used_and_available_guest_accounts 
 get("/guestaccess.json/guestAccountLicenseUsage")
end 
